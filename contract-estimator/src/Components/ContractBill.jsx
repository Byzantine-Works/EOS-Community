    ...
    return (
        <div className="ContractBill">
            ...
            <div className="RTContainer">
                <ul>CPU: {(totalRT.cpu_us*props.cpuRate).toFixed(4)} EOS</ul>
                <ul>NET: {(totalRT.net_bytes*props.netRate).toFixed(4)} EOS</ul>
                <ul>RAM: {(totalRT.ram_bytes*props.ramPrice).toFixed(4)} EOS</ul>
            </div>
            ...
            {props.csvData ? <CSVLink data={props.csvData} target="_blank" headers = {[{label:"Generated by Byzantine/LibertyBlock", key: "action"}, {label:"NET (bytes/day)", key: "net_bytes"}, {label:"RAM (bytes)", key: "ram_bytes"}, {label:"CPU (µs/day)", key: "cpu_us"}, {label:"Total (EOS)", key: "total_EOS"}]}><div className="LinkContainer">Download csv</div></CSVLink> : null} 
